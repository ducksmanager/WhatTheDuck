import WtdTest.Companion.activityInstance
    ...
    override fun apply(statement: Statement, frameworkMethod: FrameworkMethod, o: Any): Statement {
        return object : Statement() {
            ...
            fun captureScreenshot(fileName: String) {
                takeScreenshot(fileName, activityInstance, SCREENSHOTS_PATH)
            }
        }
    }

    companion object {
        private const val SCREENSHOTS_PATH = "test-screenshots"
        const val SCREENSHOTS_PATH_SHOWCASE = "test-screenshots/showcase"
